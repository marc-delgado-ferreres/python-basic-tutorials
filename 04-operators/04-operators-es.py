...
# Como resultado, el valor de "igualdad" será:
# False
...
# Como resultado, el valor de "mayor_que_menor_que" será:
# False
...
# Como resultado, el valor de "mayor_o_igual_que_menor_o_igual_que" será:
# False
...
# Como resultado, el valor de "distinto_de" será:
# False
...
# Como resultado, ya que ambas expresiones no son verdaderas, la variable "and_logico" será:
# False
...
and_logico = False and True
print(and_logico)

# En este ejemplo, la expresión "False and True" se evalúa.
# Como resultado, ya que ambas expresiones no son verdaderas, la variable "and_logico" será:
# False
...
# Como resultado, ya que ambas expresiones son verdaderas, la variable "and_logico" será:
# True
...
# En este ejemplo, la expresión "False and False" se evalúa.
# Como resultado, ya que no hay al menos una de las expresiones que sea verdadera, la variable "or_logico" será:
# False
...
# Como resultado, ya que al menos una de las expresiones es verdadera, la variable "or_logico" será:
# True

or_logico = False or True
print(or_logico)

# En este ejemplo, la expresión "False or True" se evalúa.
# Como resultado, ya que al menos una de las expresiones es verdadera, la variable "or_logico" será:
# True
...
# Como resultado, ya que se niega el valor verdadero, la variable "not_logico" será:
# False
